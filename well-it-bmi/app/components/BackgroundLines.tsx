...
export function BackgroundLinesDemo() {
  return (
    <BackgroundLines className="flex items-center justify-center z-40 w-full flex-col px-4">
      <h2 className="bg-clip-text text-transparent bg-gradient-to-b from-tP to-tS text-3xl md:text-4xl lg:text-7xl  py-2 md:py-10 relative z-20 font-bold tracking-tight">
      ...
      <p className="max-w-xl mx-auto text-sm md:text-lg text-tF text-center">
